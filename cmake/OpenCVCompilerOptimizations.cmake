...
endmacro()
ocv_optimization_process_obsolete_option(ENABLE_SSE SSE ON IF (NOT EMSCRIPTEN))
ocv_optimization_process_obsolete_option(ENABLE_SSE2 SSE2 ON IF (NOT EMSCRIPTEN))
ocv_optimization_process_obsolete_option(ENABLE_SSE3 SSE3 ON IF (NOT EMSCRIPTEN))
ocv_optimization_process_obsolete_option(ENABLE_SSSE3 SSSE3 ON IF (NOT EMSCRIPTEN))
ocv_optimization_process_obsolete_option(ENABLE_SSE41 SSE4_1 ON IF (NOT EMSCRIPTEN))
ocv_optimization_process_obsolete_option(ENABLE_SSE42 SSE4_2 ON IF (NOT EMSCRIPTEN))
ocv_optimization_process_obsolete_option(ENABLE_POPCNT POPCNT ON IF (NOT EMSCRIPTEN))
ocv_optimization_process_obsolete_option(ENABLE_AVX AVX ON IF (NOT EMSCRIPTEN))
ocv_optimization_process_obsolete_option(ENABLE_AVX2 AVX2 ON IF (NOT EMSCRIPTEN))
ocv_optimization_process_obsolete_option(ENABLE_FMA3 FMA3 ON IF (NOT EMSCRIPTEN))
...
if(X86 OR X86_64 AND NOT EMSCRIPTEN)
